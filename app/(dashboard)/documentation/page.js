        ...
        <Col lg={12} md={12} sm={12}>
          <div className="border-bottom pb-4 mb-4 d-md-flex justify-content-between align-items-center">
            <div className="mb-3 mb-md-0">
              <h1 className="mb-0 h2 fw-bold">Commit Diary</h1>
              <p className="mb-0">
                Welcome to Commit Diary - the professional dashboard for your
                git commit history.
              </p>
            </div>
          </div>
        ...
        <Col lg={7} md={12} sm={12}>
          <Card>
            <Card.Body>
              ...
              <p className="lead">
                Commit Diary is a professional kit that comes with plenty of
                ready-to-use components that will help you to visualize your
                development productivity.
              </p>

              <p>
                Commit Diary is built with the most popular front-end framework{" "}
                <a
              ...
              <p>
                This doc will guide you to understand how Commit Diary is
                organized and how to customize your dashboard.
              </p>
              ...
              <ol>
                ...
                <li>
                  {" "}
                  <h4 className="mb-0 fw-bold">Install Commit Diary</h4>
                  <p>
                    Open the <span>commitdiary </span>
                  ...
                  <p>
                    ...
                    for Commit Diary in the node_modules directory.
                  </p>
                </li>
                <li>
