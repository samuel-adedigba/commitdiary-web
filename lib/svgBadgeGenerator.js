...
export const generateBadgeSVG = ({ repos, timeline, stats, languages = [] }) => {
  ...
  return `
    <svg width="100%" height="auto" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Commit Diary activity report">
      <defs>
      ...
      <g transform="translate(${width - outerPad - 350}, ${height - 92})">
        ...
        <text x="175" y="40" fill="#f5f3ef" font-size="26" text-anchor="middle">Share badge ↗</text>
      </g>
    </svg>
  `;
};
