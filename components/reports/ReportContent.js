...
const ReportContent = ({ report }) => {
  ...
  const providerLabel =
    report.provider_used && report.provider_used !== "unknown"
      ? report.provider_used
      : "Source unavailable";
  const hasGenerationTime = Number.isFinite(report.generation_time_ms);
    ...
    <div className="report-content">
      ...
      <div className="border-top pt-3 mt-3">
        <small className="text-muted">
          Generated by <strong>{providerLabel}</strong>
          {hasGenerationTime && (
